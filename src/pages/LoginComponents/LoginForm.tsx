...
const LoginForm: React.FC<LoginFormProps> = ({
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg p-6 sm:p-8 border border-blue-100 hover:shadow-xl transition-all duration-300">
      <h2 className="text-xl sm:text-2xl font-bold text-gray-800 mb-4 sm:mb-6">Welcome Back</h2>
      ...
      <form onSubmit={handleLogin}>
        <div className="space-y-5 sm:space-y-6">
          <div>
            <label className="block text-gray-700 text-xs sm:text-sm font-medium mb-1 sm:mb-2">Email Address</label>
          ...
          <div>
            <label className="block text-gray-700 text-xs sm:text-sm font-medium mb-1 sm:mb-2">Password</label>
            <div className="relative">
